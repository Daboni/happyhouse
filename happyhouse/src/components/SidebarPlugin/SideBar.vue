        ...
        <div class="container-fluid">
            ...
            <slot name="mobile-right">
                <ul class="nav align-items-center d-md-none">
                    ...
                    <base-dropdown class="nav-item" menu-on-right tag="li" title-tag="a" v-if="userInfo">
...
<!---->
                        <div class="dropdown-divider"></div>
                      <div @click="onClickLogout" class="dropdown-item" >
                            <i class="ni ni-user-run"></i>
                            <span id="logoutBtn">Logout</span>
                      </div>
                    </base-dropdown>
                  <router-link :to="{name: 'login'}" v-else class="font-weight-bold text-white rounded bg-primary p-2">로그인 </router-link>
